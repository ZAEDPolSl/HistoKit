...
parser.add_argument('--scale_thumbnail', help='Factor used to scale small thumbnails to show algorithms results (scaled from magnification for tissue detection).'
                                              ' When value is None scale_thumbnail will be set to 0.625/args.tissdet_mag.',default=None, type=int)
...
if __name__ == "__main__":
    ...
    if args.scale_thumbnail is None:
        args.scale_thumbnail = 0.625/args.tissdet_mag
